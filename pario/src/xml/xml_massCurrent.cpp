...
void parIO::xml_massCurrent(glsol &sol){

  const std::string fname = "rank_xmls/" + sol.config.xmf2_massCurrent_fname + "_" + std::to_string(hila::myrank()) + ".xml";
  ...
  xml_out << "<Grid Name=\"dyGiLa-sim-massCurrent\" Type=\"Uniform\">\n"
	  ...
	  << std::flush;
         ...
         xml_out << "  <Attribute Name=\"jm_1\""
		         << " AttributeType=\"Scalar\" Center=\"Node\">\n"
                         << "   <DataItem Format=\"HDF\" DataType=\"Float\" Precision=\"8\" Dimensions=" << "\""
                         << dim_0 << " " << dim_1 << " " << dim_2 << "\"" << ">" << "\n"
	                 << "    domain_" << std::setfill('0') << std::setw(6) << hila::myrank()
		         << ".hdf5:/mesh/fields/jm1Container/values"
		         << "\n"
                         << "   </DataItem>\n"
                         << "  </Attribute>"
	                 << "\n"
		         ...
		         << " AttributeType=\"Scalar\" Center=\"Node\">\n"
                         ...
                         << dim_0 << " " << dim_1 << " " << dim_2 << "\"" << ">" << "\n"
	                 << "    domain_" << std::setfill('0') << std::setw(6) << hila::myrank()
		         << ".hdf5:/mesh/fields/jm2Container/values"
		         << "\n"
                         << "   </DataItem>\n"
                         << "  </Attribute>"
			 << "\n"  
		         ...
		         << " AttributeType=\"Scalar\" Center=\"Node\">\n"
                         ...
                         << dim_0 << " " << dim_1 << " " << dim_2 << "\"" << ">" << "\n"
	                 << "    domain_" << std::setfill('0') << std::setw(6) << hila::myrank()
		         << ".hdf5:/mesh/fields/jm3Container/values"
		         << "\n"
                         << "   </DataItem>\n"
                         << "  </Attribute>"
		         ...
		         << " AttributeType=\"Scalar\" Center=\"Node\">\n"
                         ...
                         << dim_0 << " " << dim_1 << " " << dim_2 << "\"" << ">" << "\n"
	                 << "    domain_" << std::setfill('0') << std::setw(6) << hila::myrank()
		         << ".hdf5:/mesh/fields/phaseExpModulusContainer/values"
		         << "\n"
                         << "   </DataItem>\n"
                         << "  </Attribute>"
		         ...
		         << " AttributeType=\"Scalar\" Center=\"Node\">\n"
                         ...
                         << dim_0 << " " << dim_1 << " " << dim_2 << "\"" << ">" << "\n"
	                 << "    domain_" << std::setfill('0') << std::setw(6) << hila::myrank()
		         << ".hdf5:/mesh/fields/phaseExpAngleContainer/values"
		         << "\n"
                         << "   </DataItem>\n"
                         << "  </Attribute>"
	                 << "  <Attribute Name=\"phaseExp2ReContainer\""
		         << " AttributeType=\"Scalar\" Center=\"Node\">\n"
                         << "   <DataItem Format=\"HDF\" DataType=\"Float\" Precision=\"8\" Dimensions=" << "\""
                         << dim_0 << " " << dim_1 << " " << dim_2 << "\"" << ">" << "\n"
	                 << "    domain_" << std::setfill('0') << std::setw(6) << hila::myrank()
		         << ".hdf5:/mesh/fields/phaseExp2ReContainer/values"
		         << "\n"
                         << "   </DataItem>\n"
                         << "  </Attribute>"
	                 << "  <Attribute Name=\"phaseExp2ImContainer\""
		         << " AttributeType=\"Scalar\" Center=\"Node\">\n"
                         << "   <DataItem Format=\"HDF\" DataType=\"Float\" Precision=\"8\" Dimensions=" << "\""
                         << dim_0 << " " << dim_1 << " " << dim_2 << "\"" << ">" << "\n"
	                 << "    domain_" << std::setfill('0') << std::setw(6) << hila::myrank()
		         << ".hdf5:/mesh/fields/phaseExp2ImContainer/values"
		         << "\n"
                         << "   </DataItem>\n"
                         << "  </Attribute>"	   	   	   
			 << "\n" << std::flush;
