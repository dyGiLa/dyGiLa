...
void parIO::xml_spinCurrent(glsol &sol){
  ...
  xml_out << "<Grid Name=\"dyGiLa-sim-spinCurrent\" Type=\"Uniform\">\n"
	  ...
	  << std::flush;
          ...
          xml_out << "  <Attribute Name=\"js_11\""
		         << " AttributeType=\"Scalar\" Center=\"Node\">\n"
                         << "   <DataItem Format=\"HDF\" DataType=\"Float\" Precision=\"8\" Dimensions=" << "\""
                         << dim_0 << " " << dim_1 << " " << dim_2 << "\"" << ">" << "\n"
	                 << "    domain_" << std::setfill('0') << std::setw(6) << hila::myrank()
		         << ".hdf5:/mesh/fields/js11Container/values"
		         << "\n"
                         << "   </DataItem>\n"
                         << "  </Attribute>"
	                 << "\n"
		         ...
		         << " AttributeType=\"Scalar\" Center=\"Node\">\n"
                         ...
                         << dim_0 << " " << dim_1 << " " << dim_2 << "\"" << ">" << "\n"
	                 << "    domain_" << std::setfill('0') << std::setw(6) << hila::myrank()
		         << ".hdf5:/mesh/fields/js21Container/values"
		         << "\n"
                         << "   </DataItem>\n"
                         << "  </Attribute>"
			 << "\n"  
		         ...
		         << " AttributeType=\"Scalar\" Center=\"Node\">\n"
                         ...
                         << dim_0 << " " << dim_1 << " " << dim_2 << "\"" << ">" << "\n"
	                 << "    domain_" << std::setfill('0') << std::setw(6) << hila::myrank()
		         << ".hdf5:/mesh/fields/js31Container/values"
		         << "\n"
                         << "   </DataItem>\n"
                         << "  </Attribute>"
                         << "\n"	    
		         ...
		         << " AttributeType=\"Scalar\" Center=\"Node\">\n"
                         ...
                         << dim_0 << " " << dim_1 << " " << dim_2 << "\"" << ">" << "\n"
	                 << "    domain_" << std::setfill('0') << std::setw(6) << hila::myrank()
		         << ".hdf5:/mesh/fields/js12Container/values"
		         << "\n"
                         << "   </DataItem>\n"
                         << "  </Attribute>"
	                 << "\n"
		         ...
		         << " AttributeType=\"Scalar\" Center=\"Node\">\n"
                         ...
                         << dim_0 << " " << dim_1 << " " << dim_2 << "\"" << ">" << "\n"
	                 << "    domain_" << std::setfill('0') << std::setw(6) << hila::myrank()
		         << ".hdf5:/mesh/fields/js22Container/values"
		         << "\n"
                         << "   </DataItem>\n"
                         << "  </Attribute>"
			 << "\n"  
		         ...
		         << " AttributeType=\"Scalar\" Center=\"Node\">\n"
                         ...
                         << dim_0 << " " << dim_1 << " " << dim_2 << "\"" << ">" << "\n"
	                 << "    domain_" << std::setfill('0') << std::setw(6) << hila::myrank()
		         << ".hdf5:/mesh/fields/js32Container/values"
		         << "\n"
                         << "   </DataItem>\n"
                         << "  </Attribute>"	    
                         << "\n"
		         ...
		         << " AttributeType=\"Scalar\" Center=\"Node\">\n"
                         ...
                         << dim_0 << " " << dim_1 << " " << dim_2 << "\"" << ">" << "\n"
	                 << "    domain_" << std::setfill('0') << std::setw(6) << hila::myrank()
		         << ".hdf5:/mesh/fields/js13Container/values"
		         << "\n"
                         << "   </DataItem>\n"
                         << "  </Attribute>"
	                 << "\n"
		         ...
		         << " AttributeType=\"Scalar\" Center=\"Node\">\n"
                         ...
                         << dim_0 << " " << dim_1 << " " << dim_2 << "\"" << ">" << "\n"
	                 << "    domain_" << std::setfill('0') << std::setw(6) << hila::myrank()
		         << ".hdf5:/mesh/fields/js23Container/values"
		         << "\n"
                         << "   </DataItem>\n"
                         << "  </Attribute>"
			 << "\n"  
		         ...
		         << " AttributeType=\"Scalar\" Center=\"Node\">\n"
                         ...
                         << dim_0 << " " << dim_1 << " " << dim_2 << "\"" << ">" << "\n"
	                 << "    domain_" << std::setfill('0') << std::setw(6) << hila::myrank()
		         << ".hdf5:/mesh/fields/js33Container/values"
		         << "\n"
                         << "   </DataItem>\n"
                         << "  </Attribute>"	    
			 << "\n" << std::flush;
